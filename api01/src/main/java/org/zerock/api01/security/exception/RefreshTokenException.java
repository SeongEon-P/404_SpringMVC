...
public class RefreshTokenException extends RuntimeException {
    ...
    // RefreshTokenException의 생성자 : 인스턴스가 생성될 때 errorCase를 생성
    ...
    public void sendResponseError(HttpServletResponse response) {
        ...
        //ContentType의 경우는 JSON형식의 데이터를 반환하도록 설정
        response.setContentType(MediaType.APPLICATION_JSON_VALUE);
        // GSON을 이용하여 에러 메세지를 JSON 형식으로 변환 후 response에 설정
        Gson gson = new Gson();
        // JSON 형식의 데이터 : 에러 메세지, 현재 시간 설정
