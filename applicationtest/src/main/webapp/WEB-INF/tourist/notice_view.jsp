                    ...
                    <ul class="gnb clear">
                        ...
                        <li><a href="javascript:;" class="openAll2">고객센터</a>
                            <div class="gnb_depth gnb_depth2_2">
                                <ul class="submenu_list">
                                    <li><a href="/noitce_list">공지사항</a></li>
    ...
    <div id="container">
        ...
        <div class="bodytext_area box_inner">
            <ul class="bbsview_list">
                ...
                <li class="bbs_date">조회수 : <span>${dto.count}</span></li>
            ...
            <form action="/notice_remove" method="post">
                <p class="btn_line txt_right">
                    <a href="javascript:;" class="btn_bbs">목록</a>

                <input type="hidden" name="id" value="${dto.no}" readonly>
